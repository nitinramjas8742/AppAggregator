 // ✅ Data (could move to separate file if grows too big)
  ...
  export const rideHailingPlatforms = [
  { 
    name: "Ola Cabs", 
 ...
 export const movieBookingLinks = [
  { 
    name: "BookMyShow", 
...
export const governmentPrepLinks = [
  {
    name: "StudyIQ",
