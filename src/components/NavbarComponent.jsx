...
export function NabvarComponent({ search, setSearch }) {
  return (
    <header className="flex border-b border-gray-300 py-3 px-4 sm:px-10 bg-white min-h-[65px] tracking-wide relative z-50">
      <div className="flex flex-wrap items-center gap-4 max-w-screen-xl mx-auto w-full">
        ...
        <div className="flex gap-4 ml-auto items-center">
          {/* 🔍 Search Bar */}
          <div className="flex max-w-xs w-full bg-gray-100 px-4 py-2.5 border border-gray-200 rounded focus-within:border-slate-900 focus-within:bg-transparent transition-all">
            <input
              type="text"
