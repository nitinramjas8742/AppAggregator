          ...
          {!isLoggedIn ? (
            ...
            <div className="hidden lg:flex items-center gap-4 relative">
              ...
              <button
                ...
                className="px-3 py-1 rounded-md border border-blue-600 bg-blue-600 text-white hover:bg-blue-700 hover:border-blue-700 text-sm transition-colors duration-200"
              >
                Logout
              </button>
            </div>
            ...
            <div className="absolute top-12 right-0 bg-white border border-gray-200 shadow-lg rounded-xl p-3 w-44 flex flex-col space-y-2 animate-fadeIn z-50">
              ...
              {isLoggedIn && (
                <NavLink
                  to="/premium"
                  onClick={() => setMenuOpen(false)}
                  className="px-3 py-2 rounded-md text-sm font-medium text-yellow-600 hover:bg-gray-100"
                >
                  Premium Apps
                </NavLink>
              )}
              ...
              {!isLoggedIn ? (
                ...
                <button
                  ...
                  className="mt-1 px-3 py-2 text-center rounded-md text-sm font-semibold border border-gray-200 hover:bg-gray-100 transition"
                >
                  Logout
                </button>
              )}
