...
export function NavbarComponent({ search, setSearch }) {
  ...
  Indian Web Store
        ...
        <div className="flex items-center gap-2 ml-auto flex-shrink-0">
          ...
          {/* Search Bar */}
          <div className="flex items-center bg-gray-100 px-3 py-2 border border-gray-200 rounded-md focus-within:border-blue-500 transition-all">
  <input
    type="text"
    placeholder="Search..."
    value={search}
